    ...
    <div className="min-h-screen bg-gradient-to-br from-pink-100 to-purple-100">
      ...
      <main className="container mx-auto px-4 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-12">
          {packages.map((pkg, index) => (
            <Card key={index} className="bg-white border-pink-200 shadow-lg hover:shadow-xl transition-shadow duration-300 flex flex-col">
              ...
              <div className="p-4 mt-auto text-center"> {/* Container for price and button */}
                <p className="text-2xl font-bold text-pink-600 mb-4">{pkg.price}</p> {/* Price right above the button */}
                <Button
        ...
        <div className="max-w-md mx-auto bg-white p-8 rounded-lg shadow-lg">
          <h2 className="text-2xl font-bold text-pink-600 mb-6">Ask something to us</h2>
